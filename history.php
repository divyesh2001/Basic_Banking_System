...
<class class="welcome">
        <h2>
            <img src="logos/t2.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="logos/t2.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
