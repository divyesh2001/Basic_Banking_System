...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/friend.png" alt="Bank" width="100" height="75" style="font-weight: bold;"> <strong>Welcoming in the WORLD BANK !</strong> <img src="logos/friend.png" alt="Bank" width="100" height="75">
        </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/bg1.jfif" width="1000" height="375" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/bg20.jfif" width="1000" height="375" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/bg30.jfif" width="1000" height="375" class="d-block w-100" alt="...">
            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="350" height="300" src="background/c10.jfif" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
